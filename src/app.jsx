...
// ============================================================
// DADOS — preços de venda conforme planilha ficha técnica
// ============================================================
const SALGADOS = [
...
const BEBIDAS = [
// Preços de venda conforme planilha (coluna “Preço de venda”)
...
{ id: “coca_200”,      nome: “Coca 200ml”,         preco: 4.00,  cmv: 1.63, tipo: “bebida” }, // planilha: R$4,00
{ id: “coca_350”,      nome: “Coca 350ml”,         preco: 6.00,  cmv: 3.32, tipo: “bebida” }, // planilha: R$6,00
{ id: “coca_ks”,       nome: “Coca KS 250ml”,      preco: 5.00,  cmv: 3.32, tipo: “bebida” }, // planilha: R$5,00
{ id: “coca_2l”,       nome: “Coca 2L”,            preco: 16.00, cmv: 9.80, tipo: “bebida” }, // planilha: R$16,00
{ id: “fanta_200”,     nome: “Fanta 200ml”,        preco: 4.00,  cmv: 1.51, tipo: “bebida” }, // planilha: R$4,00
{ id: “fanta_2l”,      nome: “Fanta 2L”,           preco: 16.00, cmv: 8.02, tipo: “bebida” }, // planilha: R$16,00
{ id: “sprite_200”,    nome: “Sprite 200ml”,       preco: 4.00,  cmv: 1.51, tipo: “bebida” }, // planilha: R$4,00
{ id: “guarana_350”,   nome: “Guaraná 350ml”,      preco: 6.00,  cmv: 3.33, tipo: “bebida” }, // planilha: R$6,00
{ id: “guarana_2l”,    nome: “Guaraná 2L”,         preco: 16.00, cmv: 7.99, tipo: “bebida” }, // planilha: R$16,00
{ id: “ouro_250”,      nome: “Ouro Verde 250ml”,   preco: 3.00,  cmv: 1.63, tipo: “bebida” }, // planilha: R$3,00
{ id: “ouro_2l”,       nome: “Ouro Verde 2L”,      preco: 12.00, cmv: 5.50, tipo: “bebida” }, // planilha: R$12,00
];
...
{ id: “pao_de_mel”,  nome: “Pão de Mel”,     preco: 8.00,  cmv: 4.30, tipo: “doce” }, // planilha: R$8,00
];
...
return (
<div style={{
background: COR.card, border: `1px solid ${corBorda}`,
  ...
  {msg ? (
    ...
    <div style={{ display: "flex", gap: 6 }}>
      <button
        ...
        disabled={!temQtd}
        style={btnFlat(temQtd ? "#3a3a3a" : "#222", { flex: 1, color: temQtd ? "#ccc" : "#555", fontSize: 12 })}
      >C</button>
      <button
        onClick={adicionarAoCarrinho}
        disabled={!temQtd}
        style={btnFlat(temQtd ? COR.laranja : "#333", { flex: 3, color: temQtd ? "#fff" : "#555" })}
      >
  ...
  {consumos.length > 0 && (
    <div style={{ background: "#1a1a2a", borderRadius: 10, padding: "10px 14px", marginBottom: 12, borderLeft: "3px solid #555" }}>
      ...
      <div style={{ color: COR.sub, fontSize: 12, marginTop: 4 }}>
        {consumos.length} item{consumos.length !== 1 ? "s" : ""} · CMV consumido: {fmt(cmvConsumos)}
      </div>
    </div>
  )}
...
lista.map((item) => (
<ItemCard key={item.id} item={item} onAddCarrinho={addCarrinho} onConsumido={registrarConsumo} />
));
